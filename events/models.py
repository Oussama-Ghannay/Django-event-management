...
class Event(models.Model):
    ...
    aa = models.CharField(default='xxx',max_length=5, )
...
class Participation(models.Model):
    ...
    # Si une tentative est faite pour créer une participation
    #  avec la même personne et le même événement, une erreur 
    # de validation sera déclenchée.
    class Meta:
